...
namespace final_aroussie {
	...
	public ref class SellingForm : public System::Windows::Forms::Form
	{
	public:

		SellingForm(Form^ form)
		{
			InitializeComponent();
			...
			this->input_balance->Validating += gcnew System::ComponentModel::CancelEventHandler(this, &SellingForm::input_balance_Validating);
			this->input_symbol->Validating += gcnew System::ComponentModel::CancelEventHandler(this, &SellingForm::input_symbol_Validating);
			this->input_number->Validating += gcnew System::ComponentModel::CancelEventHandler(this, &SellingForm::input_number_Validating);
			this->input_price->Validating += gcnew System::ComponentModel::CancelEventHandler(this, &SellingForm::input_price_Validating);
	...
	private:
		//Calculate the total revenue of the sold
	...
	//Save the information into the log file
	private: void saveTransaction(float totalRevenue) {
		...
		float priceByUnit = float::Parse(input_price->Text);
		string str = "Type of transaction: Selling";

		/*Save data into the file*/
		file << str << endl;
		file << "Balance: " << balance << " $" << endl;
		file << "Date of the selling: " + date << endl;
		file << "Stock symbol: " + symbol << endl;
		file << "Number of shares sold: " << numberShares << endl;
...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->label_title->Text = L"Selling shares";
				 // 
				 // label_balance
				 // 
				 ...
				 this->label_symbol->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(0)));
				 this->label_symbol->Location = System::Drawing::Point(12, 148);
				 ...
				 this->label_number->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(0)));
				 this->label_number->Location = System::Drawing::Point(14, 183);
				 this->label_number->Name = L"label_number";
				 this->label_number->Size = System::Drawing::Size(144, 13);
				 this->label_number->TabIndex = 3;
				 this->label_number->Text = L"Number of shares to sell";
				 // 
				 // label_date
				 // 
				 ...
				 this->label_date->Size = System::Drawing::Size(72, 13);
				 this->label_date->TabIndex = 4;
				 this->label_date->Text = L"Date to sell";
				 // 
				 // label_price
				 // 
				 ...
				 this->btn_calculate->Click += gcnew System::EventHandler(this, &SellingForm::btn_calculate_Click);
				 // 
				 // errorProvider1
				 // 
				 ...
				 this->cancel_btn->Click += gcnew System::EventHandler(this, &SellingForm::cancel_btn_Click);
				 // 
				 // BuyingForm
				 // 
				 ...
				 this->Name = L"SellingForm";
				 this->Text = L"SellingForm";
