...
namespace final_aroussie {
	...
	public ref class SellingReceipt : public System::Windows::Forms::Form
	{
	public:

		/*All the seters of the outputs (called in SellingForm.h)*/
...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->label_title->Text = L"Receipt of the selling";
				 // 
				 // label_stock
				 // 
				 ...
				 this->label_stock->Size = System::Drawing::Size(67, 13);
				 this->label_stock->TabIndex = 1;
				 this->label_stock->Text = L"Stock sold";
				 // 
				 // label_number
				 // 
				 ...
				 this->label_number->Size = System::Drawing::Size(133, 13);
				 this->label_number->TabIndex = 2;
				 this->label_number->Text = L"Number of shares sold";
				 // 
				 // label_price
				 // 
				 ...
				 this->label_price->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(0)));
				 this->label_price->Location = System::Drawing::Point(15, 220);
				 this->label_price->Name = L"label_price";
				 this->label_price->Size = System::Drawing::Size(118, 13);
				 this->label_price->TabIndex = 3;
				 this->label_price->Text = L"Total revenue price";
				 // 
				 // output_stock
				 // 
				 ...
				 this->label_question->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(0)));
				 this->label_question->Location = System::Drawing::Point(28, 269);
				 this->label_question->Name = L"label_question";
				 this->label_question->Size = System::Drawing::Size(378, 15);
				 ...
				 this->btn_home->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(0)));
				 this->btn_home->Location = System::Drawing::Point(71, 316);
				 ...
				 this->btn_home->Click += gcnew System::EventHandler(this, &SellingReceipt::btn_home_Click);
				 ...
				 this->btn_exit->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(0)));
				 this->btn_exit->Location = System::Drawing::Point(260, 316);
				 this->btn_exit->Name = L"btn_exit";
				 this->btn_exit->Size = System::Drawing::Size(75, 23);
				 this->btn_exit->TabIndex = 11;
				 this->btn_exit->Text = L"Exit";
				 this->btn_exit->UseVisualStyleBackColor = false;
				 this->btn_exit->Click += gcnew System::EventHandler(this, &SellingReceipt::btn_exit_Click);
				 // 
				 // SellingReceipt
				 // 
				 ...
				 this->Name = L"SellingReceipt";
				 this->Text = L"SellingReceipt";
